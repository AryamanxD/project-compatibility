(function (){
    ...
    const onEvents = function(events , target , callback , options){
    ...
    const checkDisplay = function(context, initanimation) {
        ...
        elements.map(element => element.dispatchEvent(new CustomEvent('slideshow-display-check' , {bubbles:true})));
    ...
    const Cover = function(element){
        ...
        const cover = {
            ...
            init: function() {
                ...
                this.element.addEventListener('slideshow-display-check' , ()=> {
                    if(!this.element.hidden) this.check();
                })
    ...
    window.awRbslider = function(element , config) {
        ...
        const slideshow = {
            ...
            init() {
                ...
                this.triggers = Array.from(this.element.querySelector('[data-uk-slideshow-item]'));
                this.update();

                // Array.from(this.element.querySelectorAll("click.uk.slideshow", (event) => {
                ...
                const resizeCallback = debounce(() => {
                    ...
                    if (this.fixFullscreen) {
                        ...
                        this.slides.map(slide => slide.style.height = window.innerHeight + 'px') ; 
            ...
            update(resize) {
                ...
                this.slides.forEach((slide,index) => {
                    ...
                    slide.data = Object.assign(slide._data || {} , {
                        media : media ,
                        sizer : media ,
                    }) ;
                    ...
                    if (media) {
                        ...
                        switch(media.nodeName) {
                            ...
                            case 'IFRAME':
                                ...
                                media.addEventListener( 'load' , ()=> {
                                    ...
                                    media.setAttribute('data-player-id', iframeId)  // add frameId for the vimeo-ready listener
                        ...
                        if (placeholder) {
                            ...
                            //   UI.$('<img style="width:100%;height:auto;">').attr('src', canvas[0].toDataURL());
                ...
                if (processed) {
                    ...
                    // this.triggers = Array.from(this.element('[data-uk-slideshow-item]'));
                    ...
                    this.slides[this.current].classList.add('uk-active') ;
                    this.slides[this.current].classList.add('area-hidden' , 'false') ;
            ...
            resize() {
                ...
                if (this.options.height === 'auto') {
                    height = Math.max.apply(this.slides.map(slide => {
                        slide.style.height = '' ;
            ...
            show(index, direction) {
                ...
                const current      = this.slides[this.current],
                    ...
                    finalize     = () => {
                        ...
                        // this.element.dispatchEvent(new CustomEvent('show.uk.slideshow', {details:[next, current, this] })); 
                    };
                ...
                this.triggers.map(trigger => {
                    trigger.matches('[data-uk-slideshow-item="'+index+'"]') ?
                    trigger.classList.add('scale-125') 
                    : trigger.classList.remove('scale-125') ;
                }) ;
            },
